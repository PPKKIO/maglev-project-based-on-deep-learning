maglev_sim MATLAB Python Package
...
2. Installing the maglev_sim Package

A. Change to the directory that contains the file setup.py and the subdirectory 
maglev_sim. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the maglev_sim Package

The maglev_sim package is on your Python path. To import it into a Python script or 
session, execute:
